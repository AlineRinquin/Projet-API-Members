...
async function getData() {
    try {
        ...
        for(let i = 0; i < responsFormat.data.length; i++){
            let user = new _users.Users(responsFormat.data[i].last_name, responsFormat.data[i].first_name, responsFormat.data[i].id, responsFormat.data[i].email, responsFormat.data[i].avatar);
...
},{"./Users":"2qWgx"}],"2qWgx":[function(require,module,exports) {
...
},{}]},["5qWSS","ijsRf"], "ijsRf", "parcelRequirecc0a")
